...
if [ -f "/Users/hyebin/go/bin/moai" ]; then
	exec "/Users/hyebin/go/bin/moai" statusline < "$temp_file"
fi

# Try user local bin directory
if [ -f "/Users/hyebin/.local/bin/moai" ]; then
	exec "/Users/hyebin/.local/bin/moai" statusline < "$temp_file"
fi
